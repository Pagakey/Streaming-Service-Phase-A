...
void init_structures(void)
{
     ...
     */
    UserListHead = NULL;
    LastUserInserted = NULL;
    New_MovieList_head = NULL;
    sentinel = NULL;
    HOR_head = NULL;
    SCI_head = NULL;
    DRM_head = NULL;
    ...
    DOC_head = NULL;
    COM_head = NULL;
    MovieTable[0] = &HOR_head;
    MovieTable[1] = &SCI_head;
    MovieTable[2] = &DRM_head;
    MovieTable[3] = &ROM_head;
    MovieTable[4] = &DOC_head;
    MovieTable[5] = &COM_head;

    sentinel = Create_User(-1);
    UserListHead = sentinel;
}
...
void destroy_structures(void)
{
     ...
     */
    User_PTR user_tmp = UserListHead;
    User_PTR sent = sentinel;
    New_movie_PTR newMoviePtr = New_MovieList_head;
    Movie_PTR moviePtr = NULL;
    Movie_PTR prev = NULL;
    int i;
    while(user_tmp->uid!=-1){
        ClearSuggestionList(user_tmp);
        ClearWatchHistory(user_tmp);
